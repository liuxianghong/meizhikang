...
public abstract class BleSQLiteOpenHelper {
	   private static final String TAG = SQLiteOpenHelper.class.getSimpleName();
        ...
        private static byte[] isInitDatabase=new byte[]{0};
	    /**
	     ...
	     */
	    public BleSQLiteOpenHelper(Context context, String name, CursorFactory factory, int version) {
